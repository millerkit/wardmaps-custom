const GRAPHQL_URL = "https://wardmapsgifts.myshopify.com/api/2024-04/graphql.json"
...
function getResultsHtml(mapsThatContainAddress) {
	return mapsThatContainAddress.map(product => `
...
async function performSearch(lat, lon, locality, state) {
	...
	const mapsThatContainAddress = getMapsThatContainAddress(lon, lat, mapsForCityAndState);
